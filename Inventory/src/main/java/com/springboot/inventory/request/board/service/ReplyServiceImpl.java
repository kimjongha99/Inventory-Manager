...
import com.springboot.inventory.request.board.repository.ReplyRepository;
...
public class ReplyServiceImpl implements ReplyService{
    ...
    public Long register(ReplyDTO replyDTO) {
        ...
        Board board = boardRepository.findById(replyDTO.getBno())
                .orElseThrow(() -> new IllegalArgumentException("Invalid bno: " + replyDTO.getBno()));
    ...
    public int countRepliesByBoardId(Long boardId) {
        return replyRepository.countByBoard_Bno(boardId);
}
}
